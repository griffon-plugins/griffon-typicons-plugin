= griffon-typicons-plugin
:linkattrs:
:project-name: griffon-typicons-plugin
...
link:https://github.com/stephenhutchings/typicons.font[TypIcons, window="_blank"] gives you scalable vector icons.
